#language: ru
Функционал: Тестирование Приложения Сервисного Центра
  ...
  Сценарий: Редактирование записи
    ...
    И пользователь нажимает кнопку "Добавить заказ", чтобы сохранить изменения
  ...
  Сценарий: Добавление заказа
    ...
    И пользователь жмёт кнопку Ок в диалоговом окне
  ...
  Сценарий: Добавление некорректных данных
    ...
    И пользователь нажимает кнопку Ок в информационном диалоговом окне
